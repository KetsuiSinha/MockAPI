...
import ChatPage from "@/components/generator/ChatPage"
...
export default function ClientLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <main className="flex-1 flex flex-col overflow-hidden bg-[var(--background)] text-[var(--foreground)]">
      ...
      {/* Header */}
      <div className="flex items-center justify-between border-b bg-[var(--background)] text-[var(--foreground)] border-[var(--border)] p-2 shadow-sm">
